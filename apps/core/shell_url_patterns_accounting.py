...
urlpatterns_accounting = [
    ...
    path("accounting/journal/new/", accounting_views.journal_create, name="journal_create"),
    path("accounting/journal/transfer/", accounting_views.journal_transfer, name="journal_transfer"),
